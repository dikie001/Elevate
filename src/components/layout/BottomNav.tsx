        ...
        {bottomNavItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center gap-0.5 min-w-[56px] py-1 px-3 rounded-lg transition-all ${
                active
                  ? "text-primary"
            ...
            >
              <Icon
                className={`w-5 h-5 ${active ? "animate-bounce-subtle" : ""}`}
              />
              <span
