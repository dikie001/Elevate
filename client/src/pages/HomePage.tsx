        ...
        <div className="bg-white/80 backdrop-blur-xl px-6 lg:px-8 py-6 lg:py-8 shadow-sm border-b border-gray-100/50">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-3">
              <div className="hidden lg:flex items-center space-x-3 px-6 py-3 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl">
                <Trophy className="w-5 h-5 text-indigo-600" />
                <span className="font-semibold text-indigo-600">Level 5</span>
              </div>
              <button className="lg:hidden p-3 rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-500 shadow-lg hover:scale-110 transition-transform">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-500">Start learning now</p>
                          </div>
                        </div>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-8 text-white shadow-2xl hover:shadow-3xl transition-all hover:scale-105">
                  <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="bg-white/20 rounded-full h-4 mb-3">
                    <div className="bg-white rounded-full h-4 w-1/4 shadow-lg"></div>
                  </div>
                ...
                {/* Achievement */}
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-lg border border-gray-100 hover:scale-105 transition-transform">
